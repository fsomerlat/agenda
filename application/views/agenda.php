<?php 
	...
	$this->load->view('header');
	 echo form_open('agenda/FormAgenda?panel=5&start=1');
?>
	<?php 
				...
				<input type="hidden" name="edicaoTipoCliente" value="<?php echo(isset($_GET["TipoCli"])) ? $_GET["TipoCli"] : ""; ?>"/>
					...
					<div class="col-md-6 btnAgenda">
						...
						<input type="hidden" name="id" value="<?php echo (isset($id)) ? $id : "" ;?>" />
							<?php echo form_submit("acao",(isset($_GET["id"])) ? "atualizar":"agendar" ,array("class" => "form-control btn btn-info", "id" => "btnAgenda"));?>
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
