				...
				<?php  if($msg = get_msg()): echo $msg; endif; ?>
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<input type="text" name="cpRuaProfissional" readonly id="cpRuaProfissional" value="<?php echo (isset($rua)) ? $rua : ""; ?>" class="form-control loading" />
						</div>					
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<label for="Bairro">Bairro</label>
							<input type="text" name="cpBairroProfissional" readonly id="cpBairroProfissional" value="<?php echo (isset($bairro)) ? $bairro : ""; ?>" class="form-control loading" />
						</div>					
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label for="Cidade">Cidade</label>
							<input type="text" name="cpCidadeProfissional" readonly id="cpCidadeProfissional" value="<?php echo (isset($cidade)) ? $cidade : ""; ?>" class="form-control loading" />
						</div>					
					</div>
					<div class="col-md-2">
						<div class="form-group">
							<label for="Estado">Estado</label>
							<input type="text" name="cpEstadoProfissional" readonly id="cpEstadoProfissional" value="<?php echo (isset($estado)) ? $estado : ""; ?>" class="form-control loading" />
						</div>					
					</div>
					<div class="col-md-12">
						<div class="form-group">
