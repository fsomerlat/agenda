...
var FormHelperAgenda = (function(){
	...
	var campoCliente = function(value) { 
		...
		if(value == "Cadastrado") {
			...
			preencheComboCliente("http://localhost/CodIgniter/cliente/service_cliente");
	...
	var bindEvents = function() {
		...
		preencheComboServico("http://localhost/CodIgniter/servico/service_servico");
		preencheComboProfissional("http://localhost/CodIgniter/profissional/service_profissional");
