var LoadServiceAgenda = (function(){
	...
	var loadServiceClientesCadastrados = function(url) {
		...
		$.ajax({
			...
			error: function() {
				...
				$(".tableAgenda").html("Houve algum com o retorno dos dados !");
			},
			success: function(retorno) { 
				...
				setTimeout(function(){
					...
					retorno.map(function(dados){
						...
						options += "<td><a href='FormAgenda?panel=5&TipoCli=CliCadastrado&acao=editar&id="+dados.idAgenda+"'><span class='glyphicon glyphicon-pencil' aria-hidden='true'></span></a></td>";
	...
	var bindEvents = function() {
		...
		loadServiceClientesCadastrados("http://localhost/CodIgniter/agenda/service_agenda_clientes_cadastrados");
		loadServiceClientesNaoCadastrados("http://localhost/CodIgniter/agenda/service_agenda_clientes_nao_cadastrados");
	}
